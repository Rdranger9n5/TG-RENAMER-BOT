...
class Config:
    ...
    OWNER_ID =  int(os.environ.get("OWNER_ID", "1654009706"))
    ...
    DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Rolexfilter:Rolexfilter@rolex.0o0saa0.mongodb.net/?retryWrites=true&w=majority")
    ...
    TIME_GAP_STORE = {}
    try:
        TRACE_CHANNEL = int(os.environ.get("TRACE_CHANNEL")) if os.environ.get("TRACE_CHANNEL", "-1001720888155") else None
    except:
        TRACE_CHANNEL = None
